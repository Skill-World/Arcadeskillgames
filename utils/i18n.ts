...
const TRANSLATIONS: Partial<Record<LanguageCode, Record<string, string>>> = {
  en: {
    ...
    'nav.cat.machines': 'Complete Machines', 
    ...
    'sol.dist.desc': 'Source directly from the factory. High-volume discounts on containers of empty cabinets or complete machines.',
